...
- Diary file: ~/Users/jay/Dropbox/github/timeless/timeline.md~ (renamed from `jay-diary.md`)
...
Your diary uses Markdown format (~timeline.md~, formerly ~jay-diary.md~) with these conventions:
...
Check that:
1. ~diary-file~ points to correct file: ~/Users/jay/Dropbox/github/timeless/timeline.md~
...
- ~~/Dropbox/github/timeless/timeline.md~ - Diary content (Markdown format)
