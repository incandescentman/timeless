...
* Structural Prototypes (Implemented 2025-10-02)
** Split Ledger
- Goal :: Fixed utility rail with ledger-inspired cards
- Highlights :: Vertical command rail, frosted month panels, accent spine on each day
- Questions :: Does fixed navigation improve speed? Does ledger styling aid task review?

** Timeline Rail
- Goal :: Horizontal week timeline with animated spine
- Highlights :: Continuous vertical rail, flexible week rows, compact cards for rapid scan
- Questions :: Is horizontal progression clearer? Any accessibility concerns with the spine?

** Notebook Columns
- Goal :: Journaling aesthetic with ruled background and two-column layout
- Highlights :: Break-inside-avoid month sections, relaxed paper palette, subtle drop shadows
- Questions :: Is readability maintained across long months? Do lined backgrounds distract?
-- **All prototypes keep underlying functionality unchanged—only layout and aesthetic shift.**
