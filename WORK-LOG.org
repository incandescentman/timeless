...
- Verified production flow: web captures write through to `data/jay-diary.md` in Dropbox; manual diary edits still require bumping the embedded timestamp comment until metadata-based detection ships.
