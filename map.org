...
* Instructions
The calendar.js file above already contains ALL NECESSARY CODE.

- Do not CREATE NEW CODE.
- DO NOT WRITE CODE

Using only EXISTING code from the calendar.js file above, give me the new FULL VERBATIM code for:
