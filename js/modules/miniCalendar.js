 ...
 * 
 * This module handles the mini calendar widget showing
 * previous, current, and next months.
 */

import { currentCalendarDate, months, daysOfWeek, getAdjustedDayIndex } from './state.js';
import { loadCalendarAroundDate } from './calendar.js';
import { goToTodayAndRefresh } from './navigation.js';

/**
 * Builds a small month-based mini calendar
 */
...
/**
 * Renders a small grid for a single month
 */
